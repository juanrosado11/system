    ...
    * {
    ...
    "<body>" .
        "<div class='contenedor'>".
            "<p>&nbsp;</p>" .
            "<p>&nbsp;</p>" .
                "<span>  <strong class='bold'>" . $nombreCliente . " . . .!</strong></span>" .
                "<p>&nbsp;</p>" .
                ...
                "<p>&nbsp;</p>" .
        "<p>GRACIAS POR CONTRIBUIR A MEJORAR NUESTRO SISTEMA. </p>" .
        "<p>&nbsp;</p>" .
        "<p><span class='bold'> TRMSYSTEM WEB! </span></p>" .
        "<p>&nbsp;</p>" .
        "<p>".
...
$cabecerasCliente .= 'From: Valledupar Colombia trmsystem.sena@gmail.com';
