...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html"><span>Trm</span>System</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="inciar.php">Iniciar sesión</a></li>
...
<section id="contact" class="section-bg">
  ...
  <div class="container" data-aos="fade-up">
    ...
    <div class="row contact-info">
      ...
      <div class="col-md-4">
        <div class="contact-address">
          ...
          <address>SERVICIO NACIONAL DE APRENDIZAJE SENA CENTRO BIOTECNOLOGICO DEL CARIBE </address>
           ...
           <address>Dirección: Kilometro 7 Salida a la Paz</address>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="contact-email">
          ...
          <h3>CORREO</h3>
          <p><a href="https://mail.google.com/mail/u/1/#inbox?compose=new">trmsystem.sena@gmail.com</a> </p>
        </div>
      </div>
    ...
    <div class="form">
      <form  id="myForm"  action="enviarEmail.php" method="post" >
        <div class="row">
          <div class="form-group col-md-6"  >
            <input type="text" class="form-control" name="nombreCliente" placeholder="Ingrese su nombre" required >
           
          </div>
          <div class="form-group col-md-6 mt-3 mt-md-0">
            <input type="email" class="form-control" name="emailCliente"   value="trmsystem.sena@gmail.com" required >
          </div>
        </div>
      
        <div class="form-group mt-3">
          <textarea class="form-control"  rows="5" name="msjCliente" placeholder="Mensaje"required ></textarea>
        </div>
          <br>
          <div class="text-center">
          <input type="submit"  class="button" value="Enviar mensaje" style="font-size: 14px;">
      ...
      <div class="container">
        <div class="row">
           <div>
            ...
            <center><p>Dirección: Kilometro 7 Salida a la Paz - 095 5717092</p></center>
